...
/// <summary>
/// Хендлер как класс — стиль для случаев с зависимостями в конструкторе.
/// Канонический стиль AvtoBus — статический метод <c>Handle</c> в статическом классе
/// (короче, покрывается генератором; регистрация — <c>AddConsumersFromAssembly</c>).
/// </summary>
